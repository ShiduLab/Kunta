...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        root.setBackgroundColor(Color.rgb(16, 20, 15));
    ...
    private void launchTextPicker() {
        ...
        // Non filtriamo con text/*: molti file manager Android dichiarano TXT/MD/LOG
        // come application/octet-stream e li renderebbero non selezionabili.
        intent.setType("*/*");
